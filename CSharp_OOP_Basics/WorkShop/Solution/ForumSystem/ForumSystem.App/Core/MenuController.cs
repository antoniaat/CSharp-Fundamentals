namespace ForumSystem.App.Core
{
    ...
    internal class MenuController
    {
        ...
        private void RedirectToAddReply()
        {
            ...
            int postId = postDetailsController.PostId;

            var addReplyController = (AddReplyController)this.controllers[(int)MenuState.AddReply];

            addReplyController.SetPostDetails(postId, this.Username);
        ...
        private void ViewPost()
        {
            ...
            var posts = this.categoryService.GetPostsById(categoryId).ToArray();
        ...
        private void OpenCategory()
        {
            ...
            categoryController.SetCategoryId(categoryIndex);
        ...
        private void LogInUser()
        {
            this.controllers
                ...
                .Select(c => (IUserRestrictedController)c)
                .ToList()
                .ForEach(rc => rc.UserLogIn());
        }
