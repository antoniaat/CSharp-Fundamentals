namespace _04_HitList
{
    ...
    public class HitList
    {
        ...
        static void PrintInformationForKilledOne(Dictionary<string, Dictionary<string, string>> hitList, string name, int targetInfoIndex)
        {
        ...
        static void ReadPeopleFromConsole(Dictionary<string, Dictionary<string, string>> hitList)
        {
            string inputLine;
